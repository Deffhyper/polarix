...
gulp.task('scripts', function() {
	return gulp.src([ // Берем все необходимые библиотеки
        ...
        'app/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js', // Bootstrap datepicker
        'app/libs/bootstrap-datepicker/locales/bootstrap-datepicker.ru.min.js' // Bootstrap locale
...
gulp.task('sprite', function () {
	var spriteData = gulp.src('app/img/png/*.+(png||jpeg)').pipe(spritesmith({
...
gulp.task('watch', ['browser-sync', 'css-libs', 'scripts', 'sprite'], function() {
	...
	gulp.watch(['app/img/png/**/*.+(png||jpeg)'], ['sprite'], browserSync.reload); // Наблюдаем за спрайтами
});
